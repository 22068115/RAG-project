...
def split_into_3_equal_pieces_with_overlap(text, overlap):
    words = text.split()
    chunks = []
    ...
    chunk1 = " ".join(words[0:chunk_size + overlap])
    chunk2 = " ".join(words[chunk_size - overlap:chunk_size * 2 + overlap])
    chunk3 = " ".join(words[chunk_size * 2 - overlap:])
...
for file_index, file_name in enumerate(file_names):
    ...
    chunks = split_into_3_equal_pieces_with_overlap(text, 50)
